...
class Sequelize {
   ...
   * @param {String|Number|Boolean} [value] An optional value to compare against. Produces a string of the form "<json path> <comparator> '<value>'".
   * @memberof Sequelize
   * @return {Sequelize.json}
   */
  static json(conditionsOrPath, comparator, value) {
    return new Utils.Json(conditionsOrPath, comparator, value);
  }
