...
class Sequelize {
   ...
   *
   * @method json
   * @param {String} tableAlias table alias to avoid "column reference * is ambiguous" error
   ...
   * @param {String|Number|Boolean} [value] An optional value to compare against. Produces a string of the form "<tableAlias>.<json path> <comparator> '<value>'".
   * @memberof Sequelize
   * @return {Sequelize.json}
   */
  static json(tableAlias, conditionsOrPath, comparator, value) {
    return new Utils.Json(tableAlias, conditionsOrPath, comparator, value);
  }
